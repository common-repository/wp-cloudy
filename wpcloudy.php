...
/*  Copyright 2013 - 2021  Benjamin DENIS  (email : contact@wpcloudy.com)
...
function wpc_duplicate_post_as_draft(){
	...
	$post = get_post(esc_html($post_id));
...
function wpc_get_my_weather_id($attr) {
    ...
    //Map
      if ($wpcloudy_map == 'yes') {
    	wp_register_script("leaflet-js", plugins_url('js/map/leaflet/leaflet.js', __FILE__), "2.0", false);
    	
    	wp_register_script("leaflet-openweathermap-js", plugins_url('js/map/leaflet/leaflet-openweathermap.js', __FILE__), "2.0", false);
      	
      	wp_register_style("leaflet-openweathermap-css", plugins_url('js/map/leaflet/leaflet-openweathermap.css', __FILE__));
      	wp_register_style("leaflet-css", plugins_url('css/leaflet.css', __FILE__));

      	wp_register_script("leaflet-permalink-js", plugins_url('js/map/leaflet/Permalink.js', __FILE__), "2.0", false);
      	wp_register_script("leaflet-permalink-layer-js", plugins_url('js/map/leaflet/Permalink.Layer.js', __FILE__), "2.0", false);
      	wp_register_script("leaflet-permalink-overlay-js", plugins_url('js/map/leaflet/Permalink.Overlay.js', __FILE__), "2.0", false);
      	wp_register_style("leaflet-languageselector-css", plugins_url('js/map/leaflet/leaflet-languageselector.css', __FILE__));
      	wp_register_script("leaflet-languageselector-js", plugins_url('js/map/leaflet/leaflet-languageselector.js', __FILE__), "2.0", false);
      	wp_register_script("leaflet-map-i18n-js", plugins_url('js/map/files/map_i18n.js', __FILE__), "2.0", false);
      	wp_register_script("leaflet-map-js", plugins_url('js/map/files/map.js', __FILE__), "2.0", false);
      	
      	wp_enqueue_script("leaflet-js");
      	wp_enqueue_style("leaflet-openweathermap-css");
      	wp_enqueue_style("leaflet-css");
      	wp_enqueue_script("leaflet-permalink-js");
      	wp_enqueue_script("leaflet-permalink-layer-js");
      	wp_enqueue_script("leaflet-permalink-overlay-js");
      	wp_enqueue_script("leaflet-openweathermap-js");
      	wp_enqueue_style("leaflet-languageselector-css");
      	wp_enqueue_script("leaflet-languageselector-js");
      	wp_enqueue_script("leaflet-map-i18n-js");          
		      	...
		      	$display_map = '
			        ...
			        <script type="text/javascript">
			        	jQuery(document).ready( function() {
							...
							//Cities
							var city = L.OWM.current({intervall: 15, lang: "fr", appId: "6c407f412bf644e72fa060adb84c6263"});
